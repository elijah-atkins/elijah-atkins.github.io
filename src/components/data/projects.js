const projects = [
    {
        ...
        tag: ['nasa', 'astronomy', 'picture', 'of', 'the', 'day', 'star', 'api', 'react', 'app', 'lambdaschool'],
    ...
    },
    {
        ...
        tag: ['crypto', 'tracker', 'dark', 'mode', 'bitcoin', 'api', 'react', 'app', 'lambdaschool'],
        title: "Dark Mode",
    ...
    },
    {
        ...
        tag: ['github', 'usercard', 'star', 'api', 'react', 'app', 'lambdaschool'],
    ...
    },
    {
        ...
        tag: ['team', 'builder', 'React', 'useState', 'lambdaschool'],
        title: 'Team Builder',
    ...
    },
    {
        ...
        tag: ['javascript', 'html5', 'css', 'react', 'lambdaschool', 'React', 'todo'],
        title: "React ToDo",
    ...
    },
    {
        ...
        tag: ['javaScript', 'canvas', 'game', 'pong', 'paddle', 'ball'],
        title: "Paddle Ball",
    ...
    },
    {
        ...
        tag: ['javascript', 'canvas', 'game', 'racing', 'game', 'demo'],
