    ...
    <div className="splash-wrap">
      ...
      <div className="splash-body">
        ...
        <div className="splash-description">
          <p>
            {" "}
            This single page web app was made with touch screens in mind. Featuring large buttons with enough space for a fingers to navigate. With a scaleable cell size which allows users to zoom in to place live cells. Built
            using React and JavaScript. Game board and Cells are generated with
            CSS styling
          </p>
        </div>
